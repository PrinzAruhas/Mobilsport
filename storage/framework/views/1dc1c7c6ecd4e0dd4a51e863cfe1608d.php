...
<body>
    ...
    <div class="container" style="margin-top: 50px; padding-bottom: 80px;">
        ...
        <div class="row g-4">
            <?php $__empty_1 = true; $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sewa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="col-md-6 col-lg-4">
                <div class="booking-card glass-card p-3">
                    <div class="d-flex justify-content-between align-items-center mb-3 px-2">
                        <span class="badge bg-white text-dark shadow-sm" style="border-radius: 8px;">#<?php echo e($sewa->id); ?></span>
                        <?php
                            $statusClass = [
                        ...
                        ?>
                        <span class="badge-ice <?php echo e($statusClass[$sewa->status] ?? 'status-menunggu'); ?>">
                            <?php echo e($statusLabel[$sewa->status] ?? $sewa->status); ?>
                    ...
                    <div class="card-img-container">
                        <?php if($sewa->gambar): ?>
                            <img src="<?php echo e(asset('storage/' . $sewa->gambar)); ?>" 
                                 alt="<?php echo e($sewa->nama_mobil); ?>"
                                 onerror="this.src='<?php echo e(asset('storage/mobil/' . $sewa->gambar)); ?>'; this.onerror=function(){this.src='https://placehold.co/600x400?text=Gambar+Mobil';}">
                        <?php else: ?>
                    ...
                    <div class="px-2">
                        <h4 class="fw-bold mb-3"><?php echo e($sewa->nama_mobil ?? 'Unit Mobil'); ?></h4>
                        
                        <div class="row mb-4">
                            <div class="col-6 border-end">
                                <small class="text-muted d-block">Check-in</small>
                                <span class="fw-bold small"><?php echo e(date('d M Y', strtotime($sewa->tgl_mulai))); ?></span>
                            </div>
                            <div class="col-6 ps-3">
                                <small class="text-muted d-block">Durasi</small>
                                <span class="fw-bold small text-primary"><?php echo e(\Carbon\Carbon::parse($sewa->tgl_mulai)->diffInDays($sewa->tgl_selesai)); ?> Hari</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <span class="price-tag">Rp <?php echo e(number_format($sewa->total_harga, 0, ',', '.')); ?></span>
                            </div>
                            <a href="/booking/<?php echo e($sewa->id); ?>" class="btn-detail shadow-sm">
...
</html><?php /**PATH C:\yujimin\karina\resources\views/booking/index.blade.php ENDPATH**/ ?>