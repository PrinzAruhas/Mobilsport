...
<div class="container py-2 main-content">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <span class="badge badge-primary shadow-sm p-2 px-3 badge-status">
            <?php echo e($daftarKerusakan->count()); ?> Tugas Masuk
        </span>
    </div>

    <div class="row">
       <?php $__empty_1 = true; $__currentLoopData = $daftarKerusakan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-start mb-3">
                <div>
                    ...
                    <?php $__currentLoopData = $item->mobil_units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <h5 class="font-weight-bold text-dark mb-0"><?php echo e($unit->mobil->merek); ?></h5>
                        <span class="text-primary font-weight-bold small d-block mb-2">
                            <i class="fas fa-tag mr-1"></i> <?php echo e($unit->no_polisi); ?>

                        </span>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <span class="badge badge-light text-danger border border-danger badge-status">Kondisi: <?php echo e(strtoupper($item->kondisi)); ?></span>
            </div>

            <div class="report-bubble mb-4">
                <small class="text-uppercase font-weight-bold text-muted d-block mb-1">
                    Laporan Masuk (User: <?php echo e($item->user->name); ?>):
                </small>
                
                <p class="text-dark font-italic mb-0">"<?php echo e($item->laporan ?? 'Tidak ada detail kerusakan.'); ?>"</p>
            </div>

            <div class="form-repair">
                
                <form action="<?php echo e(route('sewa.updateStatus', $item->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
            ...
            <div class="mt-3 text-center">
                <small class="text-muted">
                    ...
                    Dikembalikan: <?php echo e(\Carbon\Carbon::parse($item->tgl_kembali_aktual)->format('d M Y H:i')); ?>
...
</html><?php /**PATH C:\yujimin\karina\resources\views/teknisi/lapor-kerusakan.blade.php ENDPATH**/ ?>