    ...
    <tr>
        <td>
            <div class="car-unit-box">
                ...
                <div>
                    <?php $__currentLoopData = $item->mobil_units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="unit-item <?php echo e(!$loop->last ? 'mb-2 pb-2 border-bottom' : ''); ?>" style="border-bottom-style: dotted !important;">
                            <div class="font-weight-bold" style="color: var(--car-dark);">
                                <?php echo e($unit->mobil->merek); ?> <span class="text-muted small"><?php echo e($unit->mobil->model); ?></span>
                            </div>
                            <div class="mt-1">
                                <span class="badge badge-primary shadow-sm" style="font-size: 9px;">
                                    <i class="fas fa-id-card-alt mr-1"></i><?php echo e($unit->no_polisi); ?>
        ...
        <td>
            <div class="font-weight-bold"><?php echo e($item->user->name); ?></div>
            <small class="text-muted">Inv: #<?php echo e($item->id); ?></small>
        </td>

        <td class="text-center">
            
            <?php if($item->laporan && Storage::disk('public')->exists($item->laporan)): ?>
                <img src="<?php echo e(asset('storage/' . $item->laporan)); ?>" 
                     class="img-proof"
                     data-toggle="modal" 
                     data-target="#modal<?php echo e($item->id); ?>">
            <?php else: ?>
        ...
        <td class="text-center">
            <span class="status-badge <?php echo e($item->kondisi == 'bagus' || $item->kondisi == 'baik' ? 'badge-baik' : 'badge-rusak'); ?>">
                <i class="fas <?php echo e($item->kondisi == 'bagus' || $item->kondisi == 'baik' ? 'fa-check-circle' : 'fa-tools'); ?>"></i>
                <?php echo e(strtoupper($item->kondisi ?? 'BAIK')); ?>
        ...
        <td>
            ...
            <?php if($item->tgl_kembali_aktual): ?>
                <div class="font-weight-bold" style="color: var(--car-dark);">
                    <?php echo e(\Carbon\Carbon::parse($item->tgl_kembali_aktual)->format('H:i')); ?>

                </div>
                <div class="text-muted small">
                    <?php echo e(\Carbon\Carbon::parse($item->tgl_kembali_aktual)->format('d M Y')); ?>
...
<div class="modal fade" id="modal<?php echo e($item->id); ?>" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="p-4">
                ...
                <img src="<?php echo e(asset('storage/bukti_kartu/' . $item->bukti_kartu)); ?>" 
                ...
                <div class="alert alert-secondary border-0 mb-0" style="border-radius: 15px;">
                    ...
                    <p class="m-0"><?php echo e($item->laporan ?? 'Unit telah diperiksa dan dinyatakan kembali dalam kondisi sesuai.'); ?></p>
                </div>
            </div>
...
</html><?php /**PATH C:\yujimin\karina\resources\views/teknisi/riwayat-servis.blade.php ENDPATH**/ ?>