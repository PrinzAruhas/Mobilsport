    ...
    <div class="container-fluid px-lg-5 py-5" style="position: relative; z-index: 1;">
        ...
        <div class="row" id="mobilGrid">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 mb-5 mobil-item" 
                 id="mobil-card-<?php echo e($mobil->id); ?>"
                 data-category="<?php echo e(strtolower($mobil->category->nama_kategori ?? '')); ?>"
                 data-search="<?php echo e(strtolower($mobil->merek . ' ' . $mobil->model . ' ' . $mobil->no_polisi)); ?>">
                ...
                <div class="card card-mobil-ice h-100">
                    <div class="mobil-img-container">
                        ...
                        <?php if($mobil->gambar): ?>
                            <img src="<?php echo e(asset('storage/' . $mobil->gambar)); ?>" alt="<?php echo e($mobil->merek); ?>" onerror="this.src='https://placehold.co/600x400?text=Mobil'">
                        <?php else: ?>
                    ...
                    <div class="card-body pt-2 px-4 pb-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <small class="text-primary font-weight-800 text-uppercase" style="letter-spacing:1.5px">
                                <?php echo e($mobil->category->nama_kategori ?? 'Standard'); ?>

                            </small>
                            <span class="badge badge-white border text-muted px-2 py-1" style="border-radius:8px">
                                <?php echo e($mobil->no_polisi); ?>

                            </span>
                        </div>

                        <h4 class="font-weight-bold text-dark mb-1"><?php echo e($mobil->merek); ?></h4>
                        <p class="text-muted small mb-4"><?php echo e($mobil->model); ?></p>

                        <div class="price-container mb-4 w-100">
                            <small class="text-muted d-block">Tarif Harian</small>
                            <span class="price-tag">Rp<?php echo e(number_format($mobil->harga_sewa, 0, ',', '.')); ?></span>
                            <small class="text-muted">/ hari</small>
                        </div>

                        <div class="d-flex">
                            <a href="<?php echo e(route('mobil.edit', $mobil->id)); ?>" class="btn btn-glass-primary flex-grow-1 mr-2 text-decoration-none text-center">
                                <i class="fas fa-pencil-alt mr-2"></i>Edit Data
                            </a>
                            <button type="button" onclick="confirmDelete('<?php echo e($mobil->id); ?>')" class="btn btn-glass-danger">
...
</html><?php /**PATH C:\yujimin\karina\resources\views/mobil/index.blade.php ENDPATH**/ ?>