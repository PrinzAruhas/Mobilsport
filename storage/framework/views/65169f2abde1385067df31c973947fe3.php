...
$message = $__bag->first($__errorArgs[0]); ?>
                                                <span class="small text-danger ml-2"><?php echo e($message); ?></span>
                                            <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a class="small font-weight-bold text-primary" href="<?php echo e(route('login')); ?>">Masuk Kembali</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
</html><?php /**PATH C:\yujimin\karina\resources\views/auth/register.blade.php ENDPATH**/ ?>