...
<body>
    ...
    <a href="<?php echo e(url('/dashboard')); ?>" class="btn-back-floating shadow-sm">
                ...
                <div class="col-md-4 mb-3 mb-md-0">
                    ...
                    <select id="filterCategory" class="form-control filter-input border-0 bg-light">
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e(strtolower($cat->nama_kategori)); ?>"><?php echo e($cat->nama_kategori); ?></option>
        ...
        <div class="container px-lg-5 mb-4">
            <div class="alert shadow-sm border-0 d-flex align-items-center justify-content-between p-3" 
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h6 class="mb-0 font-weight-bold">Promo Aktif: <span class="text-warning"><?php echo e($activePromoCode); ?></span></h6>
                        <small class="opacity-75">Potongan tambahan <?php echo e($activePromoDiscount); ?>% otomatis terpasang!</small>
                    </div>
                </div>
                <form action="<?php echo e(route('booking.remove_promo')); ?>" method="POST" class="mb-0">
                    <?php echo csrf_field(); ?>
        ...
        <div class="row" id="mobilGrid">
            <?php $__empty_1 = true; $__currentLoopData = $mobils; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mobil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-4 mobil-item" 
                     data-category="<?php echo e(strtolower($mobil->category->nama_kategori ?? '')); ?>"
                     data-search="<?php echo e(strtolower($mobil->merek . ' ' . $mobil->model)); ?>">
                    
                    <div class="card card-mobil-ice h-100 shadow-sm border-0 position-relative">
                        <div class="status-overlay">
                            <?php if($tersedia > 0): ?>
                                <span class="badge badge-ice status-ready"><i class="fas fa-snowflake mr-1"></i> <?php echo e($tersedia); ?> Ready</span>
                            <?php else: ?>
                        ...
                        <div class="mobil-img-container">
                            <img src="<?php echo e(asset('storage/' . $mobil->gambar)); ?>" class="<?php echo e($tersedia == 0 ? 'grayscale' : ''); ?>">
                        </div>

                        <div class="card-body d-flex flex-column p-4">
                            <div class="mb-2 d-flex justify-content-between">
                                <span class="text-primary small font-weight-bold"><?php echo e($mobil->category->nama_kategori ?? 'Standard'); ?></span>
                                <span class="text-muted small"><?php echo e($mobil->transmisi); ?></span>
                            </div>
                            
                            <h5 class="card-title-custom mb-1"><?php echo e($mobil->merek); ?></h5>
                            <p class="text-muted small mb-3"><?php echo e($mobil->model); ?></p>

                            <div class="d-flex flex-wrap mb-3" style="gap: 5px;">
                                <?php if($mobil->diskon > 0): ?>
                                    <div class="unit-pill bg-danger text-white border-0">
                                        <i class="fas fa-percentage mr-1"></i> -<?php echo e($mobil->diskon); ?>%
                                    </div>
                                <?php endif; ?>

                                <?php if($diskonRedeem > 0): ?>
                                    <div class="unit-pill bg-warning text-dark border-0">
                                        <i class="fas fa-magic mr-1"></i> Extra -<?php echo e($diskonRedeem); ?>%
                                    </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="mt-auto">
                                <div class="d-flex justify-content-between align-items-end mb-3">
                                    <div>
                                        ...
                                        <?php if($mobil->diskon > 0 || $diskonRedeem > 0): ?>
                                            <small class="text-muted"><del>Rp <?php echo e(number_format($hargaAwal, 0, ',', '.')); ?></del></small><br>
                                            <span class="price-text text-danger">Rp <?php echo e(number_format($hargaAkhir, 0, ',', '.')); ?></span>
                                        <?php else: ?>
                                            <span class="price-text">Rp <?php echo e(number_format($hargaAwal, 0, ',', '.')); ?></span>
                                        <?php endif; ?>
                                    </div>
                                ...
                                <?php if($tersedia > 0): ?>
                                    <a href="<?php echo e(route('mobil.show', $mobil->id)); ?>" class="btn btn-ice btn-block btn-modern shadow-sm">
...
</html><?php /**PATH C:\yujimin\karina\resources\views/mobil/katalog.blade.php ENDPATH**/ ?>