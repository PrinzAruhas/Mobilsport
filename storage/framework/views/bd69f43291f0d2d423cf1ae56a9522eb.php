                    ...
                    <form action="<?php echo e(route('profile.update')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="avatar-wrapper">
                            <img id="preview-img" class="avatar-image" 
                                 src="<?php echo e($user->avatar ? asset('storage/'.$user->avatar) : 'https://ui-avatars.com/api/?name='.urlencode($user->name).'&background=a2d2ff&color=fff&bold=true'); ?>" 
                                 alt="Foto Profil">
                        ...
                        <div class="text-center">
                            <h3 class="font-weight-bold text-dark mb-1"><?php echo e($user->name); ?></h3>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="email" class="form-control form-control-ice" 
                                   value="<?php echo e($user->email); ?>" disabled style="cursor: not-allowed; opacity: 0.6;">
                        </div>
...
</html><?php /**PATH C:\yujimin\karina\resources\views/profile/profile.blade.php ENDPATH**/ ?>