...
<div class="container p-3">
    <div class="glass-container mx-auto text-center">
        ...
        <form action="<?php echo e(route('booking.apply_promo')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
?>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $promos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php $isUsed = in_array($p->id, $usedPromoIds); ?>
                
                <div class="available-promo d-flex align-items-center <?php echo e($isUsed ? 'used' : ''); ?>" 
                     onclick="<?php echo e($isUsed ? "alert('Anda sudah pernah menggunakan promo ini.')" : "useThisCode('$p->code')"); ?>">
                    
                    <div class="bg-dark text-white rounded px-2 py-1 mr-3 small font-weight-bold">
                        <?php echo e($p->discount_percent); ?>%
                    </div>
                    ...
                    <div class="flex-grow-1">
                        ...
                        <small class="text-muted">
                            <?php echo e($isUsed ? 'Sudah pernah diklaim' : 'Klik untuk menggunakan kode'); ?>

                        </small>
                    </div>
                    
                    <i class="fas <?php echo e($isUsed ? 'fa-lock' : 'fa-chevron-right'); ?> text-light small"></i>
                </div>
        ...
        <a href="<?php echo e(url()->previous()); ?>" class="btn btn-link btn-sm text-muted mt-4">
...
</html><?php /**PATH C:\yujimin\karina\resources\views/booking/redeem.blade.php ENDPATH**/ ?>