                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="font-weight-bold text-dark"><?php echo e($unit->mobil->merek); ?></div>
                                        <small><?php echo e($unit->mobil->model); ?> - <?php echo e($unit->warna); ?></small>
                                    </td>
                                    <td><span class="text-monospace font-weight-bold"><?php echo e($unit->no_polisi); ?></span></td>
                                    <td>
                                        <span class="status-badge <?php echo e($unit->status == 'rusak' ? 'bg-rusak' : 'bg-servis'); ?>">
                                            <?php echo e($unit->status); ?>

                                        </span>
                                    </td>
                                    <td class="text-center">
                                        <?php if($unit->status == 'rusak'): ?>
                                            <form action="/servis/update/<?php echo e($unit->id); ?>" method="POST" class="d-inline">
                                                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\yujimin\karina\resources\views/teknisi/servis.blade.php ENDPATH**/ ?>