...
<div class="container py-5 main-content">
            ...
            <div class="glass-card">
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-7 p-4 p-md-5">
                        ...
                        <form action="<?php echo e(route('sewa.store')); ?>" method="POST" enctype="multipart/form-data" id="rentalForm">
                            <?php echo csrf_field(); ?>
                            <?php $__currentLoopData = $mobils; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <input type="hidden" name="unit_ids[]" value="<?php echo e($item->id); ?>">
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <input type="hidden" name="tgl_mulai" value="<?php echo e($tgl_mulai); ?>">
                            <input type="hidden" name="durasi" value="<?php echo e($durasi); ?>">
                            <input type="hidden" name="total_harga" value="<?php echo e($total_final); ?>">
    ...
    <button type="button" id="btnSimulasiBayar" class="btn btn-success btn-block mt-3 py-2 font-weight-bold shadow-sm">
                        ...
                        <div class="units-list-container mb-4" style="max-height: 380px; overflow-y: auto;">
                            ...
                            <div class="card mb-3 border-0 shadow-sm" style="border-radius: 15px;">
                                <div class="card-body p-3 d-flex align-items-center">
                                   <img src="<?php echo e(asset('storage/' . $item->foto_unit)); ?>" 
     ...
     onerror="this.onerror=null;this.src='https://placehold.co/160x110/eef7fb/a2d2ff?text=No+Image';">
                                    <div>
                                        <h6 class="font-weight-bold mb-0"><?php echo e($item->merek); ?></h6>
                                        <span class="badge badge-light border"><?php echo e($item->no_polisi); ?></span>
                                    </div>
                                </div>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="d-flex justify-content-between mb-2">
        ...
        <span class="font-weight-bold"><?php echo e($durasi); ?> Hari</span>
    </div>

    
    <?php if($mobil->diskon > 0): ?>
    <div class="d-flex justify-content-between mb-2">
        <span class="text-danger small font-weight-bold">Flash Sale (<?php echo e($mobil->diskon); ?>%)</span>
        <span class="text-danger font-weight-bold">
            ...
            ?>
            - Rp<?php echo e(number_format($potonganUnit, 0, ',', '.')); ?>
    ...
    <?php if($potonganRedeem > 0): ?>
    <div class="d-flex justify-content-between mb-2">
        <span class="text-success small font-weight-bold">
            Kode Promo (<?php echo e($promo['code'] ?? 'REDEEM'); ?>)
        </span>
        <span class="text-success font-weight-bold">
            - Rp<?php echo e(number_format($potonganRedeem, 0, ',', '.')); ?>
    ...
    <div class="d-flex justify-content-between mb-2">
        ...
        <span class="font-weight-bold text-dark">Rp<?php echo e(number_format($biaya_admin, 0, ',', '.')); ?></span>
    </div>
    ...
    <div class="d-flex justify-content-between align-items-end">
        <div>
            ...
            <span class="h3 font-weight-bold text-primary mb-0">
                Rp<?php echo e(number_format($total_final, 0, ',', '.')); ?>
            ...
            <div class="modal-body p-0">
                <div class="receipt-paper mx-auto" style="max-width: 380px;" id="areaStruk">
                    <div class="text-center mb-4">
                        ...
                        <small class="text-muted">ID Transaksi: TRX-<?php echo e(rand(100000, 999999)); ?></small>
                    </div>
                    ...
                    <div class="row small mb-2">
                        ...
                        <div class="col-6 text-right font-weight-bold"><?php echo e(date('d/m/Y H:i')); ?></div>
                    </div>
                    ...
                    <div class="small">
                        ...
                        <div class="d-flex justify-content-between mb-1">
                            <span><?php echo e($item->merek); ?> <small class="text-muted">(<?php echo e($item->no_polisi); ?>)</small></span>
                            <span>Ready</span>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
    ...
    <div class="d-flex flex-column">
        ...
        <?php if($totalHemat > 0): ?>
            <small class="text-success font-weight-bold">
                <i class="fas fa-check-circle mr-1"></i> Berhasil hemat Rp<?php echo e(number_format($totalHemat, 0, ',', '.')); ?>
...
</html><?php /**PATH C:\yujimin\karina\resources\views/mobil/sewa.blade.php ENDPATH**/ ?>