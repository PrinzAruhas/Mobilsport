...
<head>
    ...
    <style>
        ...
        .bg-login-image {
            background: url("<?php echo e(asset('assets/img/login-bg.jpg')); ?>") center/cover no-repeat !important;
            position: relative;
            display: flex;
            align-items: center;
            justify-content: center;
                            ...
                            <div class="col-lg-6 bg-white">
                                <div class="p-5">
                                    <div class="text-center mb-4">
                                        <img src="<?php echo e(asset('assets/img/logo.png')); ?>" alt="Logo" class="brand-logo" onerror="this.style.display='none'">
                                    ...
                                    <form class="user" method="POST" action="<?php echo e(route('login')); ?>" id="loginForm">
                                        <?php echo csrf_field(); ?> <div class="form-group mb-3">
                                            <label class="small ml-2 font-weight-bold">Email</label>
                                            <input type="email" name="email" class="form-control form-control-user" placeholder="nama@email.com" value="<?php echo e(old('email')); ?>" required autofocus>
                                            <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                <span class="text-danger small ml-2"><?php echo e($message); ?></span>
                                            <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a class="small font-weight-bold text-primary" href="<?php echo e(route('register')); ?>">Buat Akun Baru</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
</html><?php /**PATH C:\yujimin\karina\resources\views/auth/index.blade.php ENDPATH**/ ?>