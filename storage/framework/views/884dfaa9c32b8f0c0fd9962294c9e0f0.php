...
<div class="container print-area">
    ...
    <div class="row mb-4">
        <div class="col-4"><strong>Total Sewa:</strong> <?php echo e($totalTransaksi); ?></div>
        <div class="col-4"><strong>Armada Siap:</strong> <?php echo e($mobilTersedia); ?> Unit</div>
        <div class="col-4"><strong>Butuh Servis:</strong> <?php echo e($mobilRusak); ?> Unit</div>
    </div>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $laporanSewa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
                ...
                <td>
                    <?php $__currentLoopData = $item->mobil_units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo e($unit->mobil->merek); ?> [<?php echo e($unit->no_polisi); ?>]<br>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </td>
                <td><?php echo e($item->created_at->format('d/m/Y')); ?></td>
                <td><?php echo e(strtoupper($item->status)); ?></td>
                <td><?php echo e(strtoupper($item->kondisi ?? 'BAGUS')); ?></td>
            </tr>
...
</html><?php /**PATH C:\yujimin\karina\resources\views/admin/statistik.blade.php ENDPATH**/ ?>