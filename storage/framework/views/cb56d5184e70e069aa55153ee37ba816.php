...
<body>
    ...
    <div class="container py-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted">Memperbarui data: <strong><?php echo e($mobil->merek); ?> <?php echo e($mobil->model); ?></strong></p>
            </div>
            <a href="<?php echo e(route('mobil.index')); ?>" class="btn-back">
                        ...
                        <div class="col-lg-7">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label>Merek</label>
                                    <input type="text" name="merek" class="form-control" value="<?php echo e($mobil->merek); ?>" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label>Model / Seri</label>
                                    <input type="text" name="model" class="form-control" value="<?php echo e($mobil->model); ?>" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label>Harga Sewa (Rp / Hari)</label>
                                    <input type="number" name="harga_sewa" class="form-control" value="<?php echo e($mobil->harga_sewa); ?>" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label>Kategori</label>
                                    <select name="category_id" class="form-control custom-select" required>
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($cat->id); ?>" <?php echo e($mobil->category_id == $cat->id ? 'selected' : ''); ?>>
                            ...
                            <div class="row bg-light p-3 rounded-lg mb-4">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="kapasitas" class="form-control custom-select">
                                        <?php $__currentLoopData = [1,2,5,7]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($cap); ?>" <?php echo e($mobil->kapasitas == $cap ? 'selected' : ''); ?>><?php echo e($cap); ?> Kursi</option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="transmisi" class="form-control custom-select">
                                        <?php $__currentLoopData = ['Dual-Clutch Transmission', 'Semiautomatic', 'Automatic', 'Manual']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trans): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($trans); ?>" <?php echo e($mobil->transmisi == $trans ? 'selected' : ''); ?>><?php echo e($trans); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="bahan_bakarnya" class="form-control custom-select">
                                        <?php $__currentLoopData = ['Bensin', 'Diesel', 'Electric']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bbm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($bbm); ?>" <?php echo e($mobil->bahan_bakarnya == $bbm ? 'selected' : ''); ?>><?php echo e($bbm); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
    ...
    <button type="button" id="addUnitBtn" class="btn btn-sm btn-outline-primary">
        <i class="fas fa-plus"></i> Tambah Unit Baru
                        ...
                        <div class="col-lg-5">
                            <div class="mb-4">
                                ...
                                <div class="preview-box mb-2" id="imgBox">
                                    <img id="imgPreview" src="<?php echo e(asset('storage/mobil/' . $mobil->gambar)); ?>" style="width:100%; height:100%; object-fit:cover;">
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="preview-box mb-2" id="videoBox">
                                    <?php if($mobil->video): ?>
                                        <video id="videoPreview" controls style="width:100%; height:100%;" src="<?php echo e(asset('storage/videos/' . $mobil->video)); ?>"></video>
                                    <?php else: ?>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="deskripsi" class="form-control" rows="4"><?php echo e($mobil->deskripsi); ?></textarea>
                    </div>
    ...
    let units = <?php echo json_encode($mobil->units, 15, 512) ?>;
    ...
    function renderUnits() {
        ...
        units.forEach((unit, i) => {
            ...
            let fotoLamaHtml = unit.foto_unit ? 
                `<img src="<?php echo e(asset('storage/units/')); ?>/${unit.foto_unit}" class="rounded mr-2 shadow-sm" style="width: 40px; height: 40px; object-fit: cover;">` : '';
    ...
    $('#addUnitBtn').on('click', function() {
        ...
        renderUnits();
            ...
            $('#formEditMobil').on('submit', function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('mobil.update', $mobil->id)); ?>",
                    type: "POST", 
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function(res) {
                        Swal.fire('Berhasil!', 'Data armada telah diperbarui ❄️', 'success')
                            .then(() => window.location.href = "<?php echo e(route('mobil.index')); ?>");
                    },
                    error: function(xhr) {
...
</html><?php /**PATH C:\yujimin\karina\resources\views/mobil/edit.blade.php ENDPATH**/ ?>